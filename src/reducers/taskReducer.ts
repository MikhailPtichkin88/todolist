import {
    addTodolistTC,
    changeTodolistEntityStatusAC, fetchTodolistTC, removeTodolistTC,
...
export const removeTaskTC = createAsyncThunk("tasks/removeTasks", async ({todolistId,taskId}: { todolistId: string, taskId:string }, {
    dispatch,
    rejectWithValue
}) => {
...
export const addTaskTC = createAsyncThunk("tasks/addTask", async ({todolistId,title}: { todolistId: string, title:string }, {
    dispatch,
    rejectWithValue
}) => {
...
export const changeTaskTC = createAsyncThunk("tasks/changeTask", async ({todolistId,taskId,domainModel}: { todolistId: string, taskId:string,domainModel:UpdateDomainModelType}, {
    dispatch,
    rejectWithValue,
    getState
}) => {
